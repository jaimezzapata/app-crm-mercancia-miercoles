    ...
    return (
        <form className="form">
            ...
            <input
                ...
                placeholder="Fecha"
            />
            <select className="input" name="" id="" onChange={(e) => setEstado(e.target.value)}>
                <option className="input" value="">Seleccione...</option>
                <option className="input" value="Pendiente">Pendiente</option>
                <option className="input" value="Creado">Creado</option>
                <option className="input" value="Cancelado">Cancelado</option>
            </select>
